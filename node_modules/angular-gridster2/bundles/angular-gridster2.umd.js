(function (global, factory) {
    ...
    GridsterPreviewComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: GridsterPreviewComponent, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }], target: i0__namespace.ɵɵFactoryTarget.Component });
    GridsterPreviewComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.1.1", type: GridsterPreviewComponent, selector: "gridster-preview", inputs: { previewStyle$: "previewStyle$", gridRenderer: "gridRenderer" }, ngImport: i0__namespace, template: '', isInline: true, styles: ["gridster-preview{position:absolute;display:none;background:#00000026}"], encapsulation: i0__namespace.ViewEncapsulation.None });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: GridsterPreviewComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    var GridsterItemComponent = /** @class */ (function () {
        function GridsterItemComponent(el, gridster, renderer, zone) {
            this.renderer = renderer;
            this.zone = zone;
            this.itemInit = new i0.EventEmitter();
            this.itemChange = new i0.EventEmitter();
            this.itemResize = new i0.EventEmitter();
            this.el = el.nativeElement;
            this.$item = {
                cols: -1,
                rows: -1,
    ...
    GridsterModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: GridsterModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    GridsterModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: GridsterModule, declarations: [GridsterComponent,
            GridsterItemComponent,
            GridsterPreviewComponent], imports: [i2.CommonModule], exports: [GridsterComponent, GridsterItemComponent] });
    GridsterModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: GridsterModule, imports: [[
                i2.CommonModule
            ]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: GridsterModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
                            GridsterComponent,
